...
import { Mail, Package, CreditCard, Tag, Heart, Smile, Eye, EyeOff } from "lucide-react"
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 flex items-center justify-center p-6 font-sans">
            <div className="w-full max-w-7xl grid md:grid-cols-2 bg-white rounded-2xl shadow-2xl overflow-hidden">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="relative">
                            ...
                            <Input
                                ...
                                className="w-full h-12 text-base border-2 border-gray-200 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10 rounded-lg transition-all pr-12"
                            />
                            <button
                                type="button"
                            ...
                            {errors.password && (
                                <p className="text-red-500 text-sm mt-1 font-medium">Warning: {errors.password}</p>
                            )}
                        </div>
                ...
                {/* Right Side - Benefits */}
                <div className="bg-gradient-to-r from-[#D7E7FF] via-[#C7DBFF] to-[#E0E6FF] p-8 md:p-12 lg:p-14 flex flex-col justify-center rounded-[20px] shadow-sm">
                    <h2 className="text-2xl font-semibold mb-10 text-gray-900 tracking-tight">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        {benefits.map((benefit, i) => {
                            ...
                            return (
                                <Card
                                    key={i}
                                    className="bg-white/95 backdrop-blur-md border border-gray-100 shadow-md hover:shadow-xl p-6 rounded-2xl transition-all duration-300 cursor-pointer hover:-translate-y-1"
                                >
                                    <div className="flex flex-col items-center text-center gap-4">
                                        <div className="w-14 h-14 bg-gradient-to-br from-[#3B82F6] to-[#2563EB] rounded-full flex items-center justify-center shadow-lg shadow-blue-500/20">
